...
import com.matchalab.subscription_killer_api.ai.dto.FilterAndCategorizeEmailsPromptParams
...
class EmailCategorizationPromptService(
    ...
    fun run(messages: List<GmailMessage>): FilterAndCategorizeEmailsResponse {

        val uniqueMessages = messages.distinctBy { it.subject to it.snippet }
        val promptParams =
            FilterAndCategorizeEmailsPromptParams(uniqueMessages.joinToString("\n") { it.toPromptParamString() })
        ...
        return chatClientService.call<FilterAndCategorizeEmailsResponse>(
